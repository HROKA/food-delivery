BEGIN;
INSERT INTO admins (name, password, rules)
VALUES ('ahmad', 'food', 'admin'),
  ('hassan', 'food', 'admin');
INSERT INTO clients (
    name,
    password,
...
Insert Into details (product_id, quantity, price, Total_price, order_id)
VALUES (1, 2, 20, 40, 1),
  (2, 1, 20, 20, 1),
  (3, 2.5, 12, 30, 1),
  (4, 2, 20, 40, 1),
